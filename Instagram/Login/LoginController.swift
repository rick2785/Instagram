...
//  Instagram
//
//  Created by Rickey Hrabowskie on 12/2/17.
...
class LoginController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        logoContainerView.anchor(top: view.safeAreaLayoutGuide.topAnchor, left: view.leftAnchor, bottom: nil, right: view.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 150)
